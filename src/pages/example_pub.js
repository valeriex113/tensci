...
export function ExamplePub() {
    return (
        <div className="bg-gray-50 min-h-screen text-gray-900 font-sans animate-fade-in pb-16">
            {/* ── Breadcrumb ── */}
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-10 items-start">
                ...
                <aside className="lg:sticky lg:top-24 flex flex-col gap-6 order-2 lg:order-1">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                        <h3 className="text-sm font-bold uppercase tracking-wide text-gray-900 mb-4 pb-3 border-b border-gray-100">
                            Article Metrics
                        </h3>
                        <div className="grid grid-cols-2 gap-4">
                            <div className="flex flex-col items-center gap-1 p-3 bg-gray-50 rounded-lg hover:-translate-y-0.5 hover:bg-blue-50 transition-all">
                                <span className="text-xl font-extrabold text-blue-600">1,234</span>
                                <span className="text-xs font-medium text-gray-500 uppercase tracking-wide">Views</span>
                            </div>
                            <div className="flex flex-col items-center gap-1 p-3 bg-gray-50 rounded-lg hover:-translate-y-0.5 hover:bg-blue-50 transition-all">
                                <span className="text-xl font-extrabold text-blue-600">56</span>
                                <span className="text-xs font-medium text-gray-500 uppercase tracking-wide">Citations</span>
                            </div>
                            <div className="flex flex-col items-center gap-1 p-3 bg-gray-50 rounded-lg hover:-translate-y-0.5 hover:bg-blue-50 transition-all">
                                <span className="text-xl font-extrabold text-blue-600">789</span>
                                <span className="text-xs font-medium text-gray-500 uppercase tracking-wide">Downloads</span>
                            </div>
                            <div className="flex flex-col items-center gap-1 p-3 bg-gray-50 rounded-lg hover:-translate-y-0.5 hover:bg-blue-50 transition-all">
                                <span className="text-xl font-extrabold text-blue-600">10</span>
                ...
                <article className="bg-white rounded-xl border border-gray-200 p-8 md:p-12 shadow-sm leading-relaxed order-1 lg:order-2">
                    ...
                    {/* ── Article Type ── */}
                    <span className="inline-block text-xs font-bold uppercase tracking-wide text-blue-600 bg-blue-50 px-3 py-1.5 rounded mb-4">
                        Research Article
                    </span>

                    {/* ── Title ── */}
                    <h1 className="font-serif text-3xl md:text-4xl font-bold leading-tight text-gray-900 mb-6 tracking-tight">
                    ...
                    {/* ── Article Meta ── */}
                    <div className="flex flex-wrap gap-6 p-4 md:px-5 bg-gray-50 rounded-lg mb-6 border border-gray-100">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <span className="text-sm font-medium text-gray-900">1 January 2026</span>
                        </div>
                        <div className="flex flex-col gap-1">
                            <span className="text-xs font-bold uppercase tracking-wide text-gray-500">Accepted</span>
                            <span className="text-sm font-medium text-gray-900">15 February 2026</span>
                        </div>
                        <div className="flex flex-col gap-1">
                            <span className="text-xs font-bold uppercase tracking-wide text-gray-500">Published</span>
                            <span className="text-sm font-medium text-gray-900">1 March 2026</span>
                        </div>
                    </div>

                    {/* ── Action Buttons ── */}
                    <div className="flex flex-wrap gap-3 mb-8">
                        <button className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-white bg-blue-600 border border-blue-600 rounded-lg hover:bg-blue-700 hover:border-blue-700 transition-colors shadow-sm">
                            <Download className="w-4 h-4" /> Download PDF
                        </button>
                        <button className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-gray-900 transition-colors shadow-sm">
                    ...
                    <section className="mb-10" id="pub-abstract">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-blue-600 inline-block">Abstract</h2>
                        <p className="text-base text-gray-900 bg-gradient-to-br from-blue-50/50 to-blue-50/20 p-5 md:p-6 border-l-4 border-blue-600 rounded-r-lg">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mb-4" id="pub-keywords">
                        ...
                        {["Keyword One", "Keyword Two", "Keyword Three",
                            "Keyword Four", "Keyword Five", "Keyword Six"].map((kw) => (
                                <span key={kw} className="inline-block text-xs font-medium text-blue-600 bg-blue-50 px-3 py-1.5 rounded-full border border-transparent hover:border-blue-200 hover:shadow-sm hover:-translate-y-px transition-all cursor-default">
                                    {kw}
                                </span>
                            ))}
                    </div>
                    ...
                    <section className="mb-10" id="pub-introduction">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-blue-600 inline-block">1. Introduction</h2>
                    ...
                    <section className="mb-10" id="pub-methods">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-blue-600 inline-block">2. Methods</h2>

                        <h3 className="text-lg font-semibold text-gray-900 mt-8 mb-3">2.1 Example Method A</h3>
                        ...
                        <figure className="my-8" id="pub-figure-1">
                            <div className="flex flex-col items-center justify-center gap-3 p-12 bg-gradient-to-br from-indigo-50/50 to-blue-50/50 border-2 border-dashed border-indigo-200 rounded-xl text-gray-500 text-sm text-center hover:border-blue-400 transition-colors">
                            ...
                            <figcaption className="text-sm text-gray-600 leading-relaxed mt-3 px-2">
                                <strong className="text-gray-900">Fig. 1.</strong> A placeholder figure caption describing the
                                diagram above. In a real article, this would explain the visual
                                representation of the methodology or data.
                            </figcaption>
                        </figure>

                        <h3 className="text-lg font-semibold text-gray-900 mt-8 mb-3">2.2 Example Method B</h3>
                        <p className="font-serif text-[15px] leading-relaxed text-gray-700 mb-4">
                        ...
                        <div className="flex items-center justify-center gap-6 p-5 my-6 bg-gray-50 rounded-xl border border-gray-100" id="pub-equation-1">
                            <span className="font-serif text-lg text-gray-900 tracking-wide">
                                y = mx + b
                            </span>
                            <span className="text-sm text-gray-500 ml-auto">(1)</span>
                        </div>

                        <h3 className="text-lg font-semibold text-gray-900 mt-8 mb-3">2.3 Example Method C</h3>
                        <p className="font-serif text-[15px] leading-relaxed text-gray-700 mb-4">
                    ...
                    <section className="mb-10" id="pub-results">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-blue-600 inline-block">3. Results</h2>
                        <p className="font-serif text-[15px] leading-relaxed text-gray-700 mb-4">
                        ...
                        <figure className="my-8" id="pub-table-1">
                            <figcaption className="text-sm text-gray-600 leading-relaxed mb-3">
                                <strong className="text-gray-900">Table 1.</strong> Example results comparing Method A, Method B, and Method C.
                            </figcaption>
                        ...
                        <figure className="my-8" id="pub-figure-2">
                            ...
                            <figcaption className="text-sm text-gray-600 leading-relaxed mt-3 px-2">
                                <strong className="text-gray-900">Fig. 2.</strong> A placeholder chart caption. In a real article,
                    ...
                    <section className="mb-10" id="pub-discussion">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-blue-600 inline-block">4. Discussion</h2>
                        <div className="space-y-4 font-serif text-[15px] leading-relaxed text-gray-700">
                            <p>
                    ...
                    <section className="mb-10" id="pub-conclusion">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-blue-600 inline-block">5. Conclusion</h2>
                    ...
                    <section className="mb-10" id="pub-acknowledgements">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-blue-600 inline-block">Acknowledgements</h2>
                        <p className="font-serif text-[15px] leading-relaxed text-gray-700">
                    ...
                    <section className="mb-10" id="pub-references">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-blue-600 inline-block">References</h2>
                        <ol className="list-decimal pl-6 space-y-3 font-serif text-[14px] leading-relaxed text-gray-700 marker:font-sans marker:font-semibold marker:text-gray-400">
                            <li id="ref-1" className="pl-1">
                                A. Author, B. Writer, <em className="text-gray-900">Title of the first example reference</em>,
                                Journal of Examples <strong className="text-gray-900">1</strong> (2020) 1–10.
                            </li>
                            <li id="ref-2" className="pl-1">
                                C. Researcher, D. Scholar, <em className="text-gray-900">Another placeholder reference title
                                    for demonstration</em>, Placeholder Reviews <strong className="text-gray-900">42</strong> (2022) 100–115.
                            </li>
                            <li id="ref-3" className="pl-1">
                                E. Scientist, <em className="text-gray-900">A third generic reference entry</em>, Generic
                                Letters <strong className="text-gray-900">7</strong> (2023) 55–60.
                            </li>
                            <li id="ref-4" className="pl-1">
                                F. Academic, G. Professor, <em className="text-gray-900">Fourth example citation for layout
                                    testing purposes</em>, Sample Journal <strong className="text-gray-900">15</strong> (2024) 200–220.
                            </li>
                            <li id="ref-5" className="pl-1">
                                H. Tester et al., <em className="text-gray-900">Fifth and final placeholder reference</em>,
                                Demo Proceedings <strong className="text-gray-900">3</strong> (2025) 50–58.
                            </li>
                        </ol>
                    </section>
