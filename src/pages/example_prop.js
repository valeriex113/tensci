            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-xl shadow-blue-900/5 relative overflow-hidden">
              ...
              <div className="mb-8">
                <div className="flex items-baseline gap-2 mb-1">
                  <span className="text-5xl font-extrabold text-gray-900 tracking-tight">$410,000</span>
              ...
              <div className="flex flex-col gap-3">
                <button className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 rounded-xl text-lg transition-all shadow-md shadow-emerald-600/20 hover:shadow-lg hover:-translate-y-0.5">
                  Back this Project
                </button>
                <div className="flex gap-3">
                  <button className="flex-1 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold py-3 rounded-xl flex items-center justify-center gap-2 transition-colors">
      ...
      <div className="sticky top-0 z-10 bg-white/80 backdrop-blur-lg border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <nav className="flex gap-8 overflow-x-auto hide-scrollbar">
            <a href="#campaign" className="py-4 text-sm font-bold text-blue-600 border-b-2 border-blue-600 whitespace-nowrap">Campaign</a>
        ...
        <div className="space-y-16 max-w-4xl">
          ...
          <div id="background">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
              <span className="w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center text-blue-600"><Target className="w-5 h-5" /></span>
              Background of the Research
            </h2>
            <div className="prose prose-lg text-gray-700 prose-blue max-w-none">
              ...
              <figure className="my-8 rounded-xl overflow-hidden bg-gray-50 border border-gray-200">
                <div className="aspect-video bg-blue-50/50 flex flex-col items-center justify-center text-center p-8 text-blue-800">
            ...
            <div className="bg-emerald-50/50 rounded-2xl border border-emerald-100 p-8">
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Build 5 Prototype O.A.S.I.S. Drones</h3>
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Conduct a 6-Month Reef Deployment</h3>
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Open-Source the AI Mapping Data</h3>
          ...
          <div id="timeline">
            ...
            <div className="relative border-l-2 border-gray-200 ml-5 space-y-12">
              <div className="relative pl-8">
                ...
                <h3 className="text-lg font-bold text-gray-900">Phase 1: Component Procurement & Assembly</h3>
              ...
              <div className="relative pl-8">
                ...
                <h3 className="text-lg font-bold text-gray-900">Phase 2: Tank Testing & AI Calibration</h3>
              ...
              <div className="relative pl-8">
                <div className="absolute -left-2 top-1.5 w-4 h-4 rounded-full bg-gray-300 ring-4 ring-white"></div>
                <h3 className="text-lg font-bold text-gray-900">Phase 3: Ocean Deployment</h3>
              ...
              <div className="relative pl-8">
                <div className="absolute -left-2 top-1.5 w-4 h-4 rounded-full bg-gray-300 ring-4 ring-white"></div>
                <h3 className="text-lg font-bold text-gray-900">Phase 4: Data Analysis & Publication</h3>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-sm">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex flex-col gap-4">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-100 to-emerald-100 border border-gray-200 flex items-center justify-center text-2xl font-bold text-gray-600">
                    SC
                  </div>
                  <div>
                    <h4 className="font-bold text-xl text-gray-900">Dr. Sarah Chen</h4>
                    <p className="text-sm text-blue-600 font-medium mb-3">Lead Principal Investigator</p>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-xl text-gray-900">Dr. James Martinez</h4>
                    <p className="text-sm text-blue-600 font-medium mb-3">Co-Investigator, Oceanography</p>
              ...
              <button className="w-full mt-8 py-3 px-4 bg-gray-50 hover:bg-gray-100 text-gray-700 text-sm font-semibold rounded-xl transition-colors border border-gray-200">
              ...
              <ul className="space-y-6">
                <li className="flex items-center gap-4 border-b border-gray-100 pb-6">
                  ...
                  <div className="flex-1">
                    <p className="text-base font-semibold text-gray-900">Anonymous</p>
                    <p className="text-sm text-gray-500">Pledged $500 • 2 hrs ago</p>
                  </div>
                </li>
                <li className="flex items-center gap-4 border-b border-gray-100 pb-6">
                  <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center text-base font-bold text-blue-700 shrink-0">MJ</div>
                  <div className="flex-1">
                    <p className="text-base font-semibold text-gray-900">Michael Jenkins</p>
                ...
                <li className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-base font-semibold text-gray-900">OceanLife Foundation</p>
